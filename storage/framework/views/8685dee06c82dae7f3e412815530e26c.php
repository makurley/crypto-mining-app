			...
			<div class="row">
				...
				<div class="col-12">
					<div class="section__title">
						<h1>About <?php echo e($settings->title); ?></h1>
						<p>At <?php echo e($settings->title); ?>, we provide seamless access to crypto mining through our trusted cloud infrastructure. No need for expensive rigs, maintenance, or technical knowledge just choose a plan and start earning passive income daily.
			...
			<div class="row row--relative">
				<div class="col-12">
					<div class="about">
						...
						<p class="about__text"><?php echo e($settings->title); ?> is a next-generation cloud mining platform providing secure, scalable, and simple access to cryptocurrency mining. We believe mining should be accessible to everyone, not just tech experts or data center owners.</p>
					...
					<div class="company">
						...
						<div class="row">
							<div class="col-12 col-xl-7">
								<p class="company__text">Founded by a team of crypto pioneers, fintech experts, and software engineers, <?php echo e($settings->title); ?> was born out of a shared frustration: crypto mining was too complex and 
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ppelfslx/ppelng.online/resources/views/about.blade.php ENDPATH**/ ?>