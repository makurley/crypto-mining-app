<?php if(auth()->check() && auth()->user()->role !== 'admin'): ?>
    <script>
        window.location.href = '<?php echo e(route('login')); ?>'; // Redirect to login if not admin
    </script>
<?php endif; ?>
<!doctype html>
...
<head>
    ...
    <!-- plugin css file  -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/assets/plugin/datatables/responsive.dataTables.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/assets/plugin/datatables/dataTables.bootstrap5.min.css')); ?>"> 
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    
    <!-- project css file  -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/assets/css/cryptoon.style.min.css')); ?>">
</head>
<body>
    ...
    <li>
        <a class="m-link active" href="<?php echo e(route('admin.dashboard')); ?>">
    ...
    <li class="collapsed">
        ...
        <ul class="sub-menu collapse" id="form">
            <li><a class="ms-link" href="<?php echo e(route('admin.plans.create')); ?>">Create plan</a></li>
            <li><a class="ms-link" href="<?php echo e(route('admin.plans.index')); ?>">Manage Plans</a></li>
        </ul>
    </li>

    <li>
        <a class="m-link" href="<?php echo e(route('admin.users')); ?>">
  ...
  <li>
        <a class="m-link" href="<?php echo e(route('admin.kyc.index')); ?>">
            <i class="fas fa-users fa-fw"></i>
            <div>
        ...
        <!-- Menu: Sub menu ul -->
        <ul class="sub-menu collapse" id="form">
             <li><a class="ms-link" href="<?php echo e(route('admin.blogs.index')); ?>">Posts</a></li>
            <li><a class="ms-link" href="<?php echo e(route('admin.blogs.create')); ?>">Create Post</a></li>
        </ul>
    </li>
    ...
    <li class="collapsed">
        ...
        <ul class="sub-menu collapse" id="form1">
            <li><a class="ms-link" href="<?php echo e(route('admin.settings.index')); ?>">System Settings</a></li>
            <li><a class="ms-link" href="<?php echo e(route('admin.referral-settings.edit')); ?>">Referral Settings</a></li>
        </ul>
    </li>
    <li>
        <a class="m-link" href="<?php echo e(route('admin.cryptowallets.index')); ?>">
    ...
    <li>
        <a class="m-link" href="<?php echo e(route('admin.deposits.index')); ?>">
    ...
    <li>
        <a class="m-link" href="<?php echo e(route('admin.withdrawals.index')); ?>">
    ...
    <li>
        <a class="m-link" href="<?php echo e(route('admin.mining.index')); ?>">
      ...
      <li class="collapsed">
        ...
        <ul class="sub-menu collapse" id="form2">
            <li><a class="ms-link" href="<?php echo e(route('admin.miner-data.index')); ?>">All Data</a></li>
            <li><a class="ms-link" href="<?php echo e(route('admin.miner-data.create')); ?>">Create Data</a></li>
        </ul>
    </li>

    <li>
        <a class="m-link" href="<?php echo e(route('plan.control')); ?>">
    ...
    <!-- Plugin Js -->
    <script src="<?php echo e(asset('assets/admin/assets/bundles/dataTables.bundle.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/admin/assets/bundles/apexcharts.bundle.js')); ?>"></script>

    <!-- Jquery Page Js -->
    <script src="<?php echo e(asset('assets/admin/assets/js/template.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/admin/assets/js/page/index.js')); ?>"></script>
</body>

</html> <?php /**PATH /home/ppelfslx/ppelng.online/resources/views/admin/layouts/master.blade.php ENDPATH**/ ?>