    ...
    <div class="container">
        <div class="row row--relative"><br><br>
            <div class="col-12">
                ...
                <form class="form" method="POST" action="<?php echo e(route('user.miner.settings.save')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="form-check form-switch mb-4">
                        <input class="form-check-input" type="checkbox" id="onMinerToggle" name="server_status" value="1" <?php echo e(auth()->user()->server_status ? 'checked' : ''); ?>>
                    ...
                    <div class="row">
                            ...
                            <div class="form__group">
                                ...
                                <select class="form__select" name="miner_location" id="miner_location" required>
                                    ...
                                    <?php $__currentLoopData = $miners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $miner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($miner->miner_location); ?>"
                                            <?php echo e(auth()->user()->miner_location === $miner->miner_location ? 'selected' : ''); ?>>
                                            <?php echo e($miner->miner_location); ?>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="form__group">
                                ...
                                <input type="text" id="selected_ip" class="form__input" value="<?php echo e(auth()->user()->miner_ip); ?>" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="form__group">
                                ...
                                <input type="text" id="up_time" class="form__input" value="<?php echo e(auth()->user()->up_time); ?>" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="form__group">
                                ...
                                <input type="text" id="status" class="form__input" value="<?php echo e(auth()->user()->status); ?>" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="form__group">
                                ...
                                <input type="text" name="miner_ip" class="form__input" id="custom_ip" value="<?php echo e(auth()->user()->miner_ip); ?>">
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#miner_location').on('change', function () {
            ...
            if (selectedLocation) {
                $.ajax({
                    url: '<?php echo e(route('user.miner.ip')); ?>', // Route to the controller method
                    method: 'GET',
...
<?php echo $__env->make('user.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ppelfslx/ppelng.online/resources/views/user/miners-setting/minersetting.blade.php ENDPATH**/ ?>