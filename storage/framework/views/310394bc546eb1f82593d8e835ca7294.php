...
<div class="section section--pb">
	<div class="container">
		<div class="row row--relative">
			<div class="col-12">
				<div class="about">
					<h2 class="about__title"><?php echo e($settings->title); ?> Plans</h2>
					<p class="about__text">MineWatts, our mining plans are strategically designed to offer investors reliable and sustainable 
					...
					hashrates, and ROI models to cater to different investment goals and risk preferences.<br>

You can select from a wide range of plans based on the cryptocurrency they wish to mine (Bitcoin, USDT, Ethereum), the duration of the contract, and the expected returns. 
Once a plan is activated, mining begins instantly, and profits are calculated and credited automatically based on real-time network conditions and the 
performance of our globally distributed mining servers.</p>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ppelfslx/ppelng.online/resources/views/mining-pools.blade.php ENDPATH**/ ?>