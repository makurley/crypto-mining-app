...
<?php $__env->startSection('content'); ?>
    ...
    <div class="alert alert-warning text-center">
        ...
        <form method="POST" action="<?php echo e(route('verification.send')); ?>" class="mt-3">
            <?php echo csrf_field(); ?>
            <button type="submit" class="btn btn-warning">
                <?php echo e(session('message') ? 'Resend Verification Link' : 'Send Verification Link'); ?>
						...
						<div class="tab-pane fade show active" id="tab-1" role="tabpanel">
							<div class="row">
								<div class="col-12 col-md-4">
									<!-- stats -->
									<div class="stats"><?php if(Auth::check()): ?>
										<span class="stats__value">$<?php echo e(number_format(Auth::user()->wallet, 2)); ?>
...
<?php endif; ?>
								...
								<div class="col-12 col-md-4">
									<!-- stats -->
									<div class="stats">
										<span class="stats__value"><?php echo e(number_format($totalDeposit, 2)); ?> </span>
								...
								<div class="col-12 col-md-4">
									<!-- stats -->
									<div class="stats">
										<span class="stats__value">$<?php echo e(number_format($totalProfit, 2)); ?></span>
								...
								<div class="col-12">
									...
									<div class="profile">
										...
										<h3 class="profile__title profile__title--mt">Start Mining</h3>
											...
											<form id="miningForm" method="POST" action="<?php echo e(route('mining.store')); ?>">
    <?php echo csrf_field(); ?>
    <div class="row">
...
<?php endif; ?>
										<div class="invest__group">
											<input id="partnerlink" type="text" name="partnerlink" class="form__input" value="<?php echo e($referralLink); ?>">
										</div>
										...
										<table class="invest__table">
											...
											<tbody>
												<tr>
													...
													<td>$<?php echo e(number_format($referralBonus, 2)); ?></td>
												</tr>
												<tr>
...
<?php if(Auth::check() && Auth::user()->ref_bonus > 0): ?>
    <form action="<?php echo e(route('referral.withdraw')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php endif; ?></td></tr>
    ...
    <?php elseif(auth()->user()->kyc_status === 'rejected'): ?>
        <div class="alert alert-danger">
         <p class="text-red-600 font-semibold text-center"><span><small>❌ Rejected: <?php echo e(auth()->user()->kyc_rejection_reason); ?> </small></span></p> 
         </div>
         
    <?php elseif(auth()->user()->kyc_status === null): ?>
        <div class="alert alert-danger">
    ...
    <?php if(auth()->user()->kyc_status !== 'approved' && auth()->user()->kyc_status !== 'pending'): ?>
        <!-- deposit -->
        <div class="deposit">
            ...
            <form action="<?php echo e(route('user.kyc.submit')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4 mt-4">
                <?php echo csrf_field(); ?>
                <div class="row">
...
<form action="<?php echo e(route('user.deposit.store')); ?>" method="POST">
    <?php echo csrf_field(); ?>
	...
	<div class="tab-content">
                <div class="tab-pane fade show active" id="tab-f6" role="tabpanel">
                    <div class="row">
                        ...
                        <form action="<?php echo e(route('user.withdraw.store')); ?>" method="POST" class="row">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="form__group">
                                    ...
                                    <select name="wallet_type" id="wallet_type" class="form__select" required>
                                        ...
                                        <?php $__currentLoopData = $wallets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wallet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($wallet->wallet_type); ?>"><?php echo e(ucfirst($wallet->wallet_type)); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                    ...
                    <script>
                        ...
                        document.getElementById('wallet_type').addEventListener('change', function () {
                            let wallets = <?php echo json_encode($wallets, 15, 512) ?>;
...
<div id="errorMessage" class="d-none mt-3">
    <ul id="errorList" class="mb-0"></ul>
        ...
        <form id="profileUpdateForm" action="<?php echo e(route('user.profile.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <div class="row"><?php if(Auth::check()): ?>
                <div class="col-12 col-xl-12">
                    <div class="form__group">
                        <label for="name1" class="form__label">Name</label>
                        <input type="text" name="name" value="<?php echo e(old('name', Auth::user()->name)); ?>" class="form__input" required>
                    </div>
                </div>
                <div class="col-12 col-xl-6">
                    <div class="form__group">
                        <label for="username" class="form__label">Username</label>
                        <input type="text" name="username" value="<?php echo e(Auth::user()->username); ?>" class="form__input" required>
                    </div>
                </div>
                <div class="col-12 col-xl-6">
                    <div class="form__group">
                        <label for="email" class="form__label">Email</label>
                        <input type="email" name="email"  value="<?php echo e(Auth::user()->email); ?>" class="form__input" required>
                    </div>
                </div>
                <div class="col-12 col-xl-6">
                    <div class="form__group">
                        <label for="address" class="form__label">Address</label>
                        <input type="text" name="address"  value="<?php echo e(old('address', Auth::user()->address)); ?>" class="form__input" required>
                    </div>
                </div>
				...
				<input id="country_selector" name="country" class="form__input" value="<?php echo e(old('country', Auth::user()->country)); ?>" type="text" required>
			</div>
                </div>
...
<div id="walletUpdateMessage" class="alert d-none mt-3"></div>
 <form id="updateCryptoWalletsForm" action="<?php echo e(route('user.crypto.wallets.update')); ?>" method="POST" class="col-12">
            ...
            <div class="col-12 col-xl-6">
                <div class="form__group">
                    ...
                    <input type="text" name="btc" class="form__input"
                           value="<?php echo e(old('btc', $cryptoWallets['btc'] ?? '')); ?>">
                </div>
            </div>
            ...
            <div class="col-12 col-xl-6">
                <div class="form__group">
                    ...
                    <input type="text" name="eth" class="form__input"
                           value="<?php echo e(old('eth', $cryptoWallets['eth'] ?? '')); ?>">
                </div>
            </div>
            ...
            <div class="col-12 col-xl-6">
                <div class="form__group">
                    ...
                    <input type="text" name="usdt" class="form__input"
                           value="<?php echo e(old('usdt', $cryptoWallets['usdt'] ?? '')); ?>">
                </div>
            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        document.getElementById("password-update-form").addEventListener("submit", function (e) {
            ...
            fetch("<?php echo e(route('user.update-password')); ?>", {
                method: "POST",
                headers: {
...
<?php echo $__env->make('user.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ppelfslx/ppelng.online/resources/views/user/dashboard.blade.php ENDPATH**/ ?>