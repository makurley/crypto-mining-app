			...
			<div class="row">
				...
				<div class="col-12 col-md-10 offset-md-1 col-lg-6 offset-lg-3">
					<div class="section__title">
						<h1>How it works?</h1>
						<p>At <?php echo e($settings->title); ?>, we simplify the process of earning from cryptocurrency mining. You don’t need to buy expensive hardware or manage complex setups. Our cloud mining system handles everything—so you can focus on profits.</p>
					</div>
				</div>
				<!-- end title -->
			</div>
...
- Mining payouts are credited to your wallet daily or as per the plan’s conditions.</p>
				...
				<div class="col-12">
					...
					<div class="section__btns">
						<a href="<?php echo e(route('register')); ?>" class="section__btn">Start Now</a>
					</div>
					<!-- end section btns -->
				</div>
			</div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ppelfslx/ppelng.online/resources/views/pages/protocols.blade.php ENDPATH**/ ?>