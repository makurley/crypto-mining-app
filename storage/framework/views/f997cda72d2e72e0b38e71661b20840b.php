...
<div class="body d-flex py-3">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="hashrate" name="hashrate" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" step="0.01" class="form-control" id="roi_value" name="roi_value" required>
    </div>
    <div class="form-group">
    ...
    <input type="number" step="0.01" name="expected_profit" class="form-control" required>
    </div>
    <div class="form-group">
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ppelfslx/ppelng.online/resources/views/admin/plans/create.blade.php ENDPATH**/ ?>