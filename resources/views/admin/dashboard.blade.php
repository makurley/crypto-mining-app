                    ...
                    <div class="row g-3 mb-3 row-cols-1 row-cols-md-2 row-cols-lg-4">
                                    ...
                                    <div class="flex-fill text-truncate">
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="price-block">
                                                <span class="fs-6 fw-bold color-price-up">{{ $totalUsers }}</span>
                                            </div>
                                            <div class="price-report">
                                                <span class="small text-success">VIEW ALL<i class="fa fa-level-up"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body d-flex align-items-center">
                                    <div class="flex-fill text-truncate">
                                        <span class="text-muted small text-uppercase">TOTAL DEPOSIT</span>
                                        <div class="d-flex flex-column">
                                            <div class="price-block">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body d-flex align-items-center">
                                    <div class="flex-fill text-truncate">
                                        <span class="text-muted small text-uppercase">ACTIVE PLAN</span>
                                        <div class="d-flex flex-column">
                                            <div class="price-block">
                                                <span class="fs-6 fw-bold">35</span>
                                            </div>
                                            <div class="price-report">
                                                <span class="small text-success">VIEW ALL<i class="fa fa-level-up"></i></span>
                                            </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body d-flex align-items-center">
                                    <div class="flex-fill text-truncate">
                                        <span class="text-muted small text-uppercase">TOTAL APPROVED WITHDRAWAL</span>
                                        <div class="d-flex flex-column">
                                            <div class="price-block">
                                                <span class="fs-6 fw-bold color-price-up">$8413</span>
                                            </div>
                                           <div class="price-report">
                                                <span class="small text-success">VIEW ALL<i class="fa fa-level-up"></i></span>
                                            </div>
