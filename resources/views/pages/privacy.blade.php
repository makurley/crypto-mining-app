			...
			<div class="row">
				...
				<div class="col-12">
					<div class="section__title">
						<h1>{{ $settings->title }} Privacy Policy</h1>	</div>
				</div>
				<!-- end title -->
			</div>
		</div>
					...
					<div class="article">
						...
						<div class="article__content">
							<div class="article__meta">
								...
								<span class="article__date"><i class="ti ti-calendar-up"></i>{{ now()->year }}</span>
							</div>

							<p>This Privacy Policy describes how {{ $settings->title }} (“we,” “us,” or “our”) collects, uses, discloses, and safeguards your information when you visit 
							...
							or using the {{ $settings->title }} platform, you consent to the practices described in this policy.</p>
...
Legitimate interests pursued by {{ $settings->title }}, including fraud prevention and service improvement.</p>
...
<p>{{ $settings->title }} uses cookies and similar technologies to enhance user experience and gather statistical data. You may choose to disable cookies through your browser settings, though doing so may affect the functionality of the platform.</p>

<h3>10. Children's Privacy</h3>

<p>{{ $settings->title }} does not knowingly collect or solicit data from anyone under the age of 18. If we discover that such data has been collected, it will be promptly deleted.</p>
...
Website: www.{{ $settings->title }}.com<p>
